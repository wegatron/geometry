...
namespace zsw
{
  ...
  void sampleTriangleAndDeformedTriangle(const Eigen::Matrix<zsw::Scalar,3,3> &deformed_tri_pts,
  ...
  template< template<typename, typename...> class Container>
    void sampleTetRefTet(
                         const Eigen::Matrix<zsw::Scalar,3,1> &v0,
                         const Eigen::Matrix<zsw::Scalar,3,1> &v1,
                         const Eigen::Matrix<zsw::Scalar,3,1> &v2,
                         const Eigen::Matrix<zsw::Scalar,3,1> &v3,
                         const Eigen::Matrix<zsw::Scalar,3,1> &rv0,
                         const Eigen::Matrix<zsw::Scalar,3,1> &rv1,
                         const Eigen::Matrix<zsw::Scalar,3,1> &rv2,
                         const Eigen::Matrix<zsw::Scalar,3,1> &rv3,
                         const zsw::Scalar ref_tet_sample_r,
                         Container<Eigen::Matrix<zsw::Scalar,3,1>> &samples)
    {
      Eigen::Matrix<zsw::Scalar,3,1> rn = rv1 - rv0;
      Eigen::Matrix<zsw::Scalar,3,1> rm = rv2 - rv0;
      Eigen::Matrix<zsw::Scalar,3,1> rp = rv3 - rv0;
      zsw::Scalar step_n = ref_tet_sample_r/rn.norm();
      zsw::Scalar step_m = ref_tet_sample_r/rm.norm();
      zsw::Scalar step_p = ref_tet_sample_r/rp.norm();
